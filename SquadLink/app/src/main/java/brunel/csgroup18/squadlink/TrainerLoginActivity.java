    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    ...
                    Intent intent = new Intent(TrainerLoginActivity.this,MainActivity.class); //Takes to main activity
        ...
        nRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                nAuth.createUserWithEmailAndPassword(username, password).addOnCompleteListener(TrainerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            Toast.makeText(TrainerLoginActivity.this, "Sign Up Error", Toast.LENGTH_SHORT).show();
                        }else{
                            String user_id = nAuth.getCurrentUser().getUid();
                            DatabaseReference current_user_db = FirebaseDatabase.getInstance().getReference().child("Users").child("Trainers").child(user_id);
        ...
        nLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String username = nUsername.getText().toString();
                final String password = nPassword.getText().toString();
                nAuth.signInWithEmailAndPassword(username, password).addOnCompleteListener(TrainerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            Toast.makeText(TrainerLoginActivity.this, "Sign In Error", Toast.LENGTH_SHORT).show();
                        }
